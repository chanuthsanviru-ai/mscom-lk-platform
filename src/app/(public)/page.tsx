    ...
    <>
      ...
      <section className="section">
        ...
        <div className="mx-auto grid max-w-7xl gap-4 md:grid-cols-3">
          {features.map((feature) => (
            <ScrollRevealWrapper key={feature.title}>
              <Card className="animate-scale-in transition-transform hover:scale-105 hover:shadow-lg">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {upcomingClasses.map((item) => (
              <ScrollRevealWrapper key={item.title}>
                <Card className="animate-scale-in border-white/10 bg-white/10 text-white transition-transform hover:scale-105 hover:shadow-lg">
      ...
      <section className="section pt-0">
        ...
        <div className="mx-auto grid max-w-4xl gap-3">
          {faqs.map((faq) => (
            <ScrollRevealWrapper key={faq.q}>
              <Card className="animate-slide-up transition-all hover:shadow-lg">
