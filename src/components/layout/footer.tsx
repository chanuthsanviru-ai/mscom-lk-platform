    ...
    <footer className="border-t border-emerald-900/10 bg-emerald-950 text-white">
      <div className="mx-auto grid max-w-7xl gap-8 px-4 py-12 md:grid-cols-[1.4fr_1fr_1fr]">
        ...
        <div>
          ...
          <a
            className="mt-4 inline-flex items-center gap-2 text-sm text-white/80 hover:text-gold-100"
            href={whatsappLink()}
          >
          ...
          <p className="mt-3 text-sm text-white/60">+94 71 809 6628</p>
      ...
      <div className="border-t border-white/10 px-4 py-4 text-center text-xs text-white/50">
        © {new Date().getFullYear()} MScom.one. All rights reserved.
      </div>
    </footer>
  );
}
